...
class conteosnonfood extends StatefulWidget {
  final String title;
  final String local;

  conteosnonfood({required this.title, required this.local});

  @override
  _conteosnonfoodState createState() => _conteosnonfoodState();
}

class _conteosnonfoodState extends State<conteosnonfood> {
