...
class conteoselectro extends StatefulWidget {
  final String title;
  final String local;

  conteoselectro({required this.title, required this.local});

  @override
  _conteoselectroState createState() => _conteoselectroState();
}

class _conteoselectroState extends State<conteoselectro> {
