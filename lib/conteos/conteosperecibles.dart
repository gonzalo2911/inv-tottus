...
class conteosperecibles extends StatefulWidget {
  final String title;
  final String local;

  conteosperecibles({required this.title, required this.local});

  @override
  _conteospereciblesState createState() => _conteospereciblesState();
}

class _conteospereciblesState extends State<conteosperecibles> {
