...
class invzonae extends StatefulWidget {
  final String local;

  invzonae({required this.local});

  @override
  _invzonaeState createState() => _invzonaeState();
}

class _invzonaeState extends State<invzonae> with TickerProviderStateMixin {
