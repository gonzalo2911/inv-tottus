...
class invzonac extends StatefulWidget {
  final String local;

  invzonac({required this.local});

  @override
  _invzonacState createState() => _invzonacState();
}

class _invzonacState extends State<invzonac> with TickerProviderStateMixin {
