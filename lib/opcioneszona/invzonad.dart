...
class invzonad extends StatefulWidget {
  final String local;

  invzonad({required this.local});

  @override
  _invzonadState createState() => _invzonadState();
}

class _invzonadState extends State<invzonad> with TickerProviderStateMixin {
