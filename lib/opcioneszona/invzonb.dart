...
class invzonab extends StatefulWidget {
  final String local;

  invzonab({required this.local});

  @override
  _invzonabState createState() => _invzonabState();
}

class _invzonabState extends State<invzonab> with TickerProviderStateMixin {
